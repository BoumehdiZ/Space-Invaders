...
public abstract class Function
{
    ...
    public static final void create(final Connection conn, final String name, final Function f, final int flags) throws SQLException {
        ...
        if (f.db.create_function(name, f, flags) != 0) {
